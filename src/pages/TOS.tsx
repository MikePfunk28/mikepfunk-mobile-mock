// pages/tos.tsx
// Place this file in your pages directory (e.g., in a Next.js or Remix app)
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={`Terms of Service for ${websiteName} and ${serviceName}.`} />
      </Helmet>

      <main className="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 md:p-12">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3">4. User Conduct</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3">5. Disclaimer of Warranties</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3">7. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3">9. Contact Us</h2>
            <p>
              If you have any questions about these Terms, please contact us at: <a href={`mailto:${contactEmail}`} className="text-blue-500 hover:underline">{contactEmail}</a>.
            </p>
          </section>
        </div>
      </main>
