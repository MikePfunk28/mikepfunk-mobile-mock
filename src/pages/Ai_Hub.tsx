        ...
        <div className="container mx-auto px-4 py-8">
          <Card className="glass-morph p-6 mb-8">
            ...
            <p className="text-funk-grey mb-4">
              AI Agent Hub is a space where you can create the necessary
              components to build your own workflows, store knowledge
              bases, store and sort research papers, or articles.  It
              is a centralized location, single pane of glass into your
              everything AI.
            </p>
            <p className="text-funk-grey">
              With AI Agent Hub, you can easily create and manage your
            ...
            <br />
            <a href="https://ai-hub.mikepfunk.com" target="_blank" rel="noopener noreferrer" className="flex text-left mb-2">

              <span className="ml-2 font-bold mb-4 text-fuchsia-500 hover:text-fuchsia-500/80">Check Out AI-Hub</span>
